...
{
    public sealed class DroneCreateCommandHandler : ICommandHandler<DroneCreateCommand, Response<DroneDTO>>
    {
        ...
        public DroneCreateCommandHandler(
        ...
        public async Task<Response<DroneDTO>> Handle(DroneCreateCommand request, CancellationToken cancellationToken)
        {
