...
{
    public sealed class DroneBatteryQueryValidator : BaseValidator<DroneBatteryQuery>
    {
        public DroneBatteryQueryValidator(IQueryRepository<Drone> queryRepository) : base()
        {
            RuleFor(p => p.Id)
